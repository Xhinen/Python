...
# Escribe un programa que almacene en un diccionario las capitales de varios países, se introducirán los datos con la forma PAIS-CAPITAL.
...
paises = {}
entrada = input("Indica un valor 'Pais:Capital' o escribe FIN INSERCIONES para finalizar\n").lower()
...
if pais_usuario in paises:
    print(f"La capital de {pais_usuario} es {paises[pais_usuario]}").capitalize()
else:
