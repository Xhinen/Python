...
lista1 = input("Introduce la primera lista de números separadas por comas: ").split(",")
lista2 = input("Introduce la segunda lista de números separadas por comas: ").split(",")
